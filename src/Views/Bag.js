...
class Bag extends Component {
    ...
    state = {
        namaproduk: ('iPhone 13 Pro Max 128GB Sierra Blue'),
        kategori: ('iPhone'),
        shipping: ('Free'),
        tax: ('$-'),
        harga: ('$1,099.00'),
        gambar1: 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-13-pro-max-blue-select?',
                ...
                <div className="d-flex justify-content-center p-4 ">
                    <div className="text-center">
                        <div className='fs-3 fw-bold'>
                            Your bag total is {this.state.harga}.
                        </div>
                        ...
                        <div className="row ">
                            <div className="col-3">
                                <Card className="text-dark bg-white border border-white">
                                    <Card.Img className='rounded mb-0 mx-auto' style={{ width: 150, height: 180 }} src={this.state.gambar1} alt="Card image" />
                                </Card>
                            </div>
                            <div className="col-9">
                                <Card className="text-dark bg-white border border-white">
                                        ...
                                        <div className="row">
                                            <div className="col-4">
                                                ...
                                                <Card.Text className='fw-normal'>
                                                    <small>
                                                        Connect with any carrier after you get your new {this.state.kategori}.
                                                    </small>
                                                </Card.Text>
                                            </div>
